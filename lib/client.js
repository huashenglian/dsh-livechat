window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function clampConfig(raw) {
			...
			out.layoutWeights.reverse = Math.max(0, Math.min(100, Number(out.layoutWeights.reverse) || 0))
		...
		function createDomRenderer() {
			...
			function spawnOne(item) {
				...
				el.addEventListener('animationend', function (e) {
					if (e.animationName === 'dsh-danmaku-fade' || e.animationName === 'dsh-danmaku-roll' || e.animationName === 'dsh-danmaku-reverse' || e.animationName === 'dsh-danmaku-rain') {
						tryRemoveDom()
					}
				})
