	...
	factory: (require) => {
		...
		function ensureStyles() {
			...
			var css = [
				...
				'.dsh-danmaku-flash{animation:dsh-danmaku-flash 2s ease;border-radius:8px;}',
		...
		function SettingsPanel(props) {
			...
			return React.createElement('div', { className: 'dsh-danmaku-card' }, [
				...
				row('emojiTotalProb', t('emojiTotalProb'), sliderField({
					min: 0, max: 0.5, step: 0.01, value: draft.emojiTotalProb != null ? draft.emojiTotalProb : 0.08,
					disabled: draft.emojiEnabled === false,
		...
		function DanmakuSettingsModal(props) {
			...
			function scrollTo(sec, flash) {
				...
				if (flash !== false) {
					el.classList.remove('dsh-danmaku-flash')
					void el.offsetWidth
					el.classList.add('dsh-danmaku-flash')
					setTimeout(function () {
						el.classList.remove('dsh-danmaku-flash')
					}, 2100)
				}
