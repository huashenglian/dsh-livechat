window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var DEFAULTS = {
			...
			advancedStyles: [
				{ id: 'as_std', name: '常规增强', weight: 3, rotate: 0, scale: 1.05, bold: false, opacity: 1 },
				{ id: 'as_tilt', name: '轻微倾斜', weight: 1, rotate: -6, scale: 1, bold: false, opacity: 0.95 },
				{ id: 'as_big', name: '大号强调', weight: 1, rotate: 0, scale: 1.35, bold: true, opacity: 1 },
			],
			styleTemplates: [
		...
		function clampConfig(raw) {
			...
			if (out.layoutWeights.reverse == null) out.layoutWeights.reverse = 0
		...
		function createDomRenderer() {
			...
			function spawnOne(item) {
				...
				var adv = null
				if (!isEmoji && kind !== 'sc' && config.advancedEnabled && (layout === 'roll' || layout === 'reverse')) {
		...
		function SettingsPanel(props) {
			...
			return React.createElement('div', { className: 'dsh-danmaku-card' }, [
				...
				row('layoutReverse', t('layoutReverse'), React.createElement('input', {
					...
					disabled: draft.advancedEnabled === false,
					...
					(draft.advancedStyles || []).map(function (s, i) {
						...
						return React.createElement('div', {
							...
							React.createElement('input', {
								...
								style: { width: 88, fontSize: 12, padding: 4, borderRadius: 6, border: '1px solid var(--dsw-alias-border-l3,rgba(0,0,0,.15))', background: 'transparent', color: 'inherit' },
								onChange: function (e) { setS({ name: e.target.value.slice(0, 20) }) }
							}),
							React.createElement('label', { key: 'wl', style: { fontSize: 11 } }, t('advWeight')),
							React.createElement('input', {
								key: 'w', type: 'number', min: 0, max: 100, step: 0.5, value: s.weight,
								style: { width: 52, fontSize: 12, padding: 4, borderRadius: 6, border: '1px solid var(--dsw-alias-border-l3,rgba(0,0,0,.15))', background: 'transparent', color: 'inherit' },
								onChange: function (e) { setS({ weight: Number(e.target.value) }) }
							}),
							React.createElement('label', { key: 'rl', style: { fontSize: 11 } }, t('advRotate')),
							React.createElement('input', {
								key: 'r', type: 'number', min: -30, max: 30, value: s.rotate,
								style: { width: 52, fontSize: 12, padding: 4, borderRadius: 6, border: '1px solid var(--dsw-alias-border-l3,rgba(0,0,0,.15))', background: 'transparent', color: 'inherit' },
								onChange: function (e) { setS({ rotate: Number(e.target.value) }) }
							}),
							React.createElement('label', { key: 'sl', style: { fontSize: 11 } }, t('advScale')),
							React.createElement('input', {
								key: 'sc', type: 'number', min: 0.8, max: 1.6, step: 0.05, value: s.scale,
								style: { width: 52, fontSize: 12, padding: 4, borderRadius: 6, border: '1px solid var(--dsw-alias-border-l3,rgba(0,0,0,.15))', background: 'transparent', color: 'inherit' },
								onChange: function (e) { setS({ scale: Number(e.target.value) }) }
							}),
							React.createElement('label', { key: 'bl', style: { fontSize: 11 } }, t('advBold')),
							React.createElement('input', {
								key: 'b', type: 'checkbox', checked: !!s.bold,
								onChange: function (e) { setS({ bold: e.target.checked }) }
							}),
							React.createElement('label', { key: 'ol', style: { fontSize: 11 } }, t('advOpacity')),
							React.createElement('input', {
								key: 'o', type: 'number', min: 0.3, max: 1, step: 0.05, value: s.opacity,
								style: { width: 52, fontSize: 12, padding: 4, borderRadius: 6, border: '1px solid var(--dsw-alias-border-l3,rgba(0,0,0,.15))', background: 'transparent', color: 'inherit' },
