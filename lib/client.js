		...
		function EmojiEditorModal(props) {
			...
			function onFile(e) {
				...
				reader.onload = function () {
					fetchJson('/api/danmaku/emojis/upload', {
						...
						setMsg(t('saved'))
						if (props.showToast) props.showToast('success', t('emojiImport'), f.name)
						reload()
					}).catch(function () {
						setMsg(t('saveFail'))
						if (props.showToast) props.showToast('error', t('saveFail'), '')
			...
			function deleteItem(id) {
				fetchJson('/api/danmaku/emojis', {
					...
					if (props.showToast) props.showToast('success', t('emojiDelete'), '')
					reload()
				}).catch(function () {
					if (props.showToast) props.showToast('error', t('saveFail'), '')
				})
			...
			return React.createElement('div', { className: 'dsh-danmaku-modal', onClick: onClose }, [
				React.createElement('div', {
					key: 'box',
					className: 'dsh-danmaku-modal-card',
					style: { width: 'min(640px,94vw)', maxHeight: '86vh', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' },
					onClick: function (e) { e.stopPropagation() }
				}, [
					React.createElement('div', {
						key: 'head',
						...
						React.createElement('div', { key: 't' }, [
							React.createElement('h3', { key: 'h', style: { margin: '0 0 4px' } }, t('emojiTitle')),
							React.createElement('div', { key: 'hint', style: { fontSize: 12, opacity: 0.7 } }, t('emojiHint'))
						]),
						React.createElement('div', { key: 'act', style: { display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 } }, [
							React.createElement('input', {
					...
					items.length === 0
						? React.createElement('div', { key: 'e', style: { opacity: 0.6, padding: '24px 0', textAlign: 'center' } }, t('emojiEmpty'))
						: React.createElement('div', {
							key: 'list',
							style: {
								overflow: 'auto',
							...
							return React.createElement('div', {
								...
								React.createElement('div', { key: 'iw', style: imgWrap }, [
								...
								React.createElement('div', {
									key: 'wr',
									style: { display: 'flex', alignItems: 'center', gap: 6, padding: '4px 8px 0' }
								}, [
					...
					React.createElement('div', { key: 'st', style: { fontSize: 12, opacity: 0.7, margin: '6px 0' } }, msg),
					React.createElement('div', { className: 'dsh-danmaku-modal-actions', key: 'a' }, [
						React.createElement('button', { key: 'x', onClick: onClose }, t('close'))
					])
				])
