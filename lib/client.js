	...
	factory: (require) => {
		...
		function ensureStyles() {
			...
			var css = [
				...
				'.dsh-danmaku-area-handle{position:absolute;width:14px;height:14px;margin:-7px 0 0 -7px;border-radius:50%;background:#22c55e;border:2px solid #fff;box-shadow:0 1px 4px rgba(0,0,0,.35);}',
				'.dsh-danmaku-area-hint{position:fixed;top:14px;left:50%;transform:translateX(-50%);z-index:10051;max-width:92vw;padding:8px 14px;border-radius:10px;font-size:12px;line-height:1.55;text-align:center;pointer-events:none;box-shadow:0 4px 16px rgba(0,0,0,.18);}',
		...
		function AreaEditor(props) {
			...
			var handles = [
				{ k: 'nw', l: '0%', tp: '0%', c: 'nwse-resize' },
				{ k: 'n', l: '50%', tp: '0%', c: 'ns-resize' },
				{ k: 'ne', l: '100%', tp: '0%', c: 'nesw-resize' },
				{ k: 'e', l: '100%', tp: '50%', c: 'ew-resize' },
				{ k: 'se', l: '100%', tp: '100%', c: 'nwse-resize' },
				{ k: 's', l: '50%', tp: '100%', c: 'ns-resize' },
				{ k: 'sw', l: '0%', tp: '100%', c: 'nesw-resize' },
				{ k: 'w', l: '0%', tp: '50%', c: 'ew-resize' }
			]
			...
			return React.createElement('div', { className: 'dsh-danmaku-area' }, [
				React.createElement('div', {
					key: 'r',
					...
					return React.createElement('div', {
						key: h.k,
						className: 'dsh-danmaku-area-handle',
						style: { left: h.l, top: h.tp, cursor: h.c },
