			...
			React.useEffect(function () {
				...
				function poll() {
					...
					fetchJson('/api/danmaku/triggers?since=' + lastSinceRef.current).then(function (data) {
						...
						if (kinds.reply_complete || kinds.task_done || kinds.tool_call || kinds.tool_error || kinds.step || kinds.todo || kinds.thinking || kinds.warning) {
						...
						if (kinds.thinking) {
							// no-op beyond lastEventAt; heartbeat generate uses thinking excerpt
						}
