					...
					React.createElement('div', {
						...
						foldersIn.map(function (f) {
							...
							return React.createElement('div', {
								...
								React.createElement('div', {
									key: 'meta',
									style: { padding: '4px 8px 2px', fontSize: 11, opacity: 0.85, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }
								}, it.name || ''),
								React.createElement('div', {
									key: 'wr',
									style: { display: 'flex', alignItems: 'center', gap: 6, padding: '0 8px 4px' }
								}, [
