window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// Content mounting is deliberately a stub: todo 14 replaces
		// mountGiftEffectContent() with the svga/image/svg adapters.
		...
		// Injection point for todo 14 (svga/image/svg adapters). Returns a
		// { destroy } handle, or null. Kept throw-free so one bad asset can't
		// wedge the queue.
